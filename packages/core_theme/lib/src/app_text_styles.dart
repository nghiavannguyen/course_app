...
class AppTextStyles {
  static const TextTheme lightTextTheme = TextTheme(
    ...
    labelSmall: TextStyle(fontSize: 11, fontWeight: FontWeight.bold, color: Colors.black),
  );
  ...
  static const TextTheme darkTextTheme = TextTheme(
    ...
    labelSmall: TextStyle(fontSize: 11, fontWeight: FontWeight.bold, color: Colors.white),
  );
}
